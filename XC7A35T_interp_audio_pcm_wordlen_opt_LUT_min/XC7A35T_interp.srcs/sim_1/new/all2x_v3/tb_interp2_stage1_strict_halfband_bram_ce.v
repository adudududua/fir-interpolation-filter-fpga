...
//=============================================================
// 文件名       : tb_interp2_stage1_strict_halfband_bram_ce.v
// 模块名       : tb_interp2_stage1_strict_halfband_bram_ce
// 功能简述     : Stage 1 strict-halfband BRAM 版本单元测试。
...
module tb_interp2_stage1_strict_halfband_bram_ce;
    ...
    initial begin
        ...
        $display("STAGE1_STRICT_BRAM_UNIT_PASS impulse=%0d random=%0d cycles=%0d",
