...
// 功能简述     : 三抽头 CIC 通带补偿器的定向与随机自检平台。
//                测试平台在 Verilog 中独立计算差分方程参考值，
//                分别验证 DATA_W 输出饱和版本与 DATA_W+1 宽输出
//                版本，并统计越过 20 bit 边界及旧接口削顶次数。
//
//                激励包含零、正负边界、曲率突变和固定种子随机值；
//                valid 延迟、舍入方向、符号扩展和饱和均逐拍检查。
//
// 当前默认配置：DATA_W=20，窄/宽两路并行比较
// 设计作者     : kafeizizi
// 创建日期     : 2026-07-29
// 版本         : V2025.2
// 开发工具     : Vivado Simulator 2025.2
// 修订记录     :
//                2026-07-29：新增补偿器边界与随机回归。
//                2026-08-16：补充中文测试目的和覆盖范围说明。
//=============================================================
