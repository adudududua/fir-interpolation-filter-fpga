...
set candidate_file [file join $script_dir \
    cic_interp16_n3_hold2_two24_mode1_candidate.v]
set result_dir [expr {$argc > 0 ? [file normalize [lindex $argv 0]] : \
    [file join $script_dir results three_dsp_two24_candidate]}]
...
# Clone the project into the result directory before editing the fileset.
# Vivado 2025.2 persists fileset changes eagerly, so this copy prevents any
# source substitution from touching the signed-off XPR.
open_project -read_only $project_file
set sandbox_dir [file join $project_dir .three_dsp_two24_sandbox]
...
require_condition [file isfile $packed_rom] \
    "Missing packed ROM initialization file: $packed_rom"
...
puts $manifest "CANDIDATE=TWO24 comb plus first-integrator low lane"
puts $manifest "TOP=$top_name"
puts $manifest "GENERICS=$candidate_generics"
puts $manifest "SOURCE=$candidate_file"
...
puts "THREE_DSP_TWO24_LUT=$lut_count"
puts "THREE_DSP_TWO24_FF=$ff_count"
puts "THREE_DSP_TWO24_DSP=$dsp_count"
puts "THREE_DSP_TWO24_BRAM18=$bram18_count"
puts "THREE_DSP_TWO24_WNS=$wns"
puts "THREE_DSP_TWO24_WHS=$whs"
puts "THREE_DSP_TWO24_DRC_ERRORS=[llength $drc_errors]"
...
puts "THREE_DSP_TWO24_CANDIDATE_PASS"
close_design
close_project
exit
