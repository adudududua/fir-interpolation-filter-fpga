...
if {$argc < 4} {
    error "usage: scan_3dsp_implementation_strategies.tcl <synth.dcp> <result_dir> <opt_directive> <place_directive>"
}
...
puts "STRATEGY_OPT=$opt_directive"
puts "STRATEGY_PLACE=$place_directive"
puts "STRATEGY_LUT=$lut_count"
puts "STRATEGY_FF=$ff_count"
puts "STRATEGY_DSP=$dsp_count"
puts "STRATEGY_BRAM18=$bram18_count"
puts "STRATEGY_WNS=$wns"
puts "STRATEGY_WHS=$whs"
puts "STRATEGY_DRC_ERRORS=[llength $drc_errors]"
