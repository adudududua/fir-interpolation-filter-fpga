...
//=============================================================
// 文件名       : interp128_all2x_v3_stage1_select_top_ce.v
// 模块名       : interp128_all2x_v3_stage1_select_top_ce
// 功能简述     : V3 Stage 1 存储结构选择公共顶层。
...
module interp128_all2x_v3_stage1_select_top_ce #(
    ...
    parameter integer USE_STRICT_STAGE1 = 0
)(
    input  wire                         clk,
    input  wire                         rst_n,
