...
//=============================================================
// 文件名       : interp128_all2x_v2_polyphase_top_ce.v
// 模块名       : interp128_all2x_v2_polyphase_top_ce
// 功能简述     : V2 Phase 2 的 Stage 2/3 true-polyphase 对比顶层。
...
//=============================================================
//=============================================================
// 1）模块名称：interp128_all2x_v2_polyphase_top_ce
// 功能说明：128 倍插值顶层：级联多级 2 倍插值、CIC 与补偿级并管理模式旁路。
// 工程版本：Vivado 2025.2。
//=============================================================

module interp128_all2x_v2_polyphase_top_ce #(
