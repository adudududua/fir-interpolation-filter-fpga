...
//=============================================================
// 文件名       : interp128_all2x_v2_lightbridge_top_ce.v
// 模块名       : interp128_all2x_v2_lightbridge_top_ce
// 功能简述     : V2 Phase 2 的 true-polyphase 与轻量桥接顶层。
//                Stage 1 保持稳定版单 DSP MAC，Stage 2/3 可按
//                FIRST_TRUE_POLYPHASE_STAGE 逐级替换，Stage 4～7
//                默认使用 Phase 1 已验证的 canonical halfband7。
//
//                级联结构：
//                  44.1kHz   -> 2x -> 88.2kHz
//                  88.2kHz   -> 2x -> 176.4kHz
...
//                2026-07-11：新增 Stage 2/3 true-polyphase 选择参数。
//                2026-07-11：六个级间桥改为 valid-only 轻量结构。
//=============================================================
//=============================================================
// 1）模块名称：interp128_all2x_v2_lightbridge_top_ce
// 功能说明：128 倍插值顶层：级联多级 2 倍插值、CIC 与补偿级并管理模式旁路。
// 工程版本：Vivado 2025.2。
//=============================================================

module interp128_all2x_v2_lightbridge_top_ce #(
    parameter integer DATA_W = 24,
    parameter integer FIRST_CANONICAL_STAGE = 4,
    parameter integer FIRST_TRUE_POLYPHASE_STAGE = 4
)(
    input  wire                         clk,
    input  wire                         rst_n,
