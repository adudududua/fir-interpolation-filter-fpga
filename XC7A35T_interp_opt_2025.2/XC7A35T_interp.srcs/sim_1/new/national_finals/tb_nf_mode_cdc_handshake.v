...
//=============================================================
//=============================================================
// 1）模块名称：tb_nf_mode_cdc_handshake
...
module tb_nf_mode_cdc_handshake;
    ...
    initial begin
        ...
        // Every directed old->new transition is exercised 100 times. Random
        // idle gaps sweep many relative phases between the unrelated clocks.
