...
set directive [expr {$argc > 0 ? [lindex $argv 0] : "AreaOptimized_high"}]
set work_dir [file normalize [file join $script_dir .. _work structure_redesign qfold256_stage23_front_ooc_$directive]]
file mkdir $work_dir
...
set sources [list \
 ...
 [file join $script_dir qfold256_stage23_front_ooc_wrapper.v]]
read_verilog $sources
synth_design -top qfold256_stage23_front_ooc_wrapper \
 -part xc7a35tfgg484-2 -mode out_of_context -include_dirs $include_dirs \
 -flatten_hierarchy full -directive $directive -resource_sharing on -shreg_min_size 5
...
close $fid
puts "QFOLD256_STAGE23_FRONT_LUT=$lut_count"
puts "QFOLD256_STAGE23_FRONT_FF=$ff_count"
puts "QFOLD256_STAGE23_FRONT_DSP=$dsp_count"
puts "QFOLD256_STAGE23_FRONT_RAMB18=$bram18_count"
