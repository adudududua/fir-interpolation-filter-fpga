...
set result_dir [file join $script_dir results active_268lut_2dsp]
...
write_checkpoint -force [file join $result_dir board_synthesized_268lut_2dsp.dcp]
...
write_checkpoint -force [file join $result_dir board_routed_268lut_2dsp.dcp]
...
require_condition [expr {$lut_count == 268}] \
    "Expected 268 LUT, got $lut_count."
require_condition [expr {$ff_count == 417}] \
    "Expected 417 FF, got $ff_count."
...
set bit_file [file join $result_dir board_demo_competition_dac8_top_268lut_2dsp.bit]
...
puts $summary "CONFIG_ID=NF-P3-STAGE123-24-20-20-2DSP-PARETO-R1"
puts $summary "STATUS=TOOL_VERIFIED_AWAITING_BOARD_TEST"
puts $summary "CIC_INTEGRATOR_DSP_MODE=0"
...
puts "ACTIVE_268LUT_2DSP_LUT=$lut_count"
puts "ACTIVE_268LUT_2DSP_FF=$ff_count"
puts "ACTIVE_268LUT_2DSP_DSP=$dsp_count"
puts "ACTIVE_268LUT_2DSP_WNS=$wns"
puts "ACTIVE_268LUT_2DSP_WHS=$whs"
puts "ACTIVE_268LUT_2DSP_BUILD_PASS"
