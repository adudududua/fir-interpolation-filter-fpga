...
set release_config_id "NF-P3-STAGE123-24-20-20-CANDIDATE-R1"
...
# release target is no more than 218 LUT while keeping
...
require_condition [expr {$lut_count <= 218}] \
    "LUT regression: expected no more than 218, got $lut_count."
require_condition [expr {$ff_count <= 365}] \
    "FF regression: expected no more than 365, got $ff_count."
