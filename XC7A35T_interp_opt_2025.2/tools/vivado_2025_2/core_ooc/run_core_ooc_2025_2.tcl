...
# Keep zero-delay OOC boundaries for the signed-off 197-LUT placement result.
...
require_condition [expr {$lut_count == 197}] \
    "Expected exactly 197 LUT for the signed-off Vivado 2025.2 OOC flow; got $lut_count."
require_condition [expr {$lutram_count == 0}] "Expected 0 LUTRAM; got $lutram_count."
require_condition [expr {$ff_count == 290}] "Expected exactly 290 FF; got $ff_count."
