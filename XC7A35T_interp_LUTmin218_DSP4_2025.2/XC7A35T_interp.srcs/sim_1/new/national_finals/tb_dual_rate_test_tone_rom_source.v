...
// 功能简述     : 双采样率 15 kHz ROM 信号源的地址和样本回归。
//                测试分别复位到 44.1 kHz 与 48 kHz 家族，检查
//                首地址、后续地址递增、256 点回绕、sample_update
//                脉冲以及输出样本与本地参考 ROM 完全一致。
//
//                family_48k 只在复位/切换流程中改变，用于验证
//                两段波形在同一 256 深度 ROM 中的起始相位约定。
//
// 当前默认配置：24 bit signed，ROM 深度 256
// 设计作者     : kafeizizi
// 创建日期     : 2026-07-29
// 版本         : V2025.2
// 开发工具     : Vivado 2025.2
// 修订记录     :
//                2026-07-29：新增双采样率 ROM 地址与数据回归。
//                2026-08-16：补充中文测试流程和判定条件。
//=============================================================
