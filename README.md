...
## 当前最低LUT且正式实板通过发布：341 LUT / 4 DSP P3-T Stage1 DSP尾周期版（2026-08-06）
...
## 全国总决赛当前正式实板通过版（2026-08-06，P3-T 341-LUT Stage1 DSP尾周期版）
