...
// National-finals experimental shared FIR engine.
//
...
module nf_interp_fir3_shared_mac_ce (
    input  wire                         clk,
    input  wire                         rst_n,
    input  wire                         ce2_out,
    input  wire                         ce4_out,
    ...
    function signed [15:0] select_short_coeff;
        ...
        begin
            ...
            if (!stage3_sel && !phase_sel) begin
                ...
                case (index_sel)
                    4'd0: select_short_coeff = 16'sd202;
                    4'd1: select_short_coeff = -16'sd1636;
                    4'd2: select_short_coeff = 16'sd9625;
                    4'd3: select_short_coeff = 16'sd9625;
                    4'd4: select_short_coeff = -16'sd1636;
                    4'd5: select_short_coeff = 16'sd202;
                    default: select_short_coeff = 16'sd0;
                endcase
            end
            else begin
                case (index_sel)
                    4'd0: select_short_coeff = -16'sd74;
                    4'd1: select_short_coeff = 16'sd261;
                    4'd2: select_short_coeff = 16'sd16008;
                    4'd3: select_short_coeff = 16'sd261;
                    4'd4: select_short_coeff = -16'sd74;
                    default: select_short_coeff = 16'sd0;
                endcase
            end
        end
    ...
    always @(posedge clk) begin
        if (rst_n && ce2_out && s1_phase == 1'b0)
            ...
            s1_read_a <= s1_history[
                ...
                (s1_wr_ptr-(S1_DELAY_INDEX+1)) : s1_read_addr_a];
