...
module tb_route2_tail_cic_full_chain_bittrue;
    ...
    interp128_route2_tail_cic_top_ce u_dut (
        .clk(clk),
        .rst_n(rst_n),
        .ce2_out(ce2_out),
        .ce4_out(ce4_out),
    ...
    task run_case;
        ...
        begin
            ...
            if (mismatch_count != 0)
                $fatal(1, "ROUTE2 FULL CHAIN case=%0d FAIL mismatches=%0d",
                    case_value, mismatch_count);
            $display("ROUTE2 FULL CHAIN case=%0d PASS y4=%0d y8=%0d y128=%0d",
    ...
    initial begin
        ...
        for (case_index = 1; case_index <= 3;
            ...
            run_case(case_index);
        $display("ROUTE2 FULL CHAIN BITTRUE PASS: impulse + nominal + full-scale random, all nodes 0 LSB.");
        $finish;
    end
