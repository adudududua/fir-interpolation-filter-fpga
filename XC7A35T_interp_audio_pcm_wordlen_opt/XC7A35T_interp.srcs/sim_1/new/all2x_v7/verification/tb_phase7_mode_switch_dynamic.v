...
`ifdef NATIONAL_FINALS_USE_DISTRIBUTED_COEFF_ROM
        .USE_NATIONAL_FINALS_DISTRIBUTED_COEFF_ROM(1),
`ifdef NATIONAL_FINALS_DISTRIBUTED_COEFF_DATA_Q
        .NATIONAL_FINALS_DISTRIBUTED_COEFF_REGISTER_OUTPUT(1)
`else
        .NATIONAL_FINALS_DISTRIBUTED_COEFF_REGISTER_OUTPUT(0)
`endif
`else
        .USE_NATIONAL_FINALS_DISTRIBUTED_COEFF_ROM(0),
        .NATIONAL_FINALS_DISTRIBUTED_COEFF_REGISTER_OUTPUT(0)
`endif
    ) u_dut (
        .clk_audio_128x(clk),
