...
$sourceDir = [System.IO.Path]::GetFullPath(
    'D:\FpgaProject\XilinxProject\XC7A35T\fir_interpolation\submit\finally\images\source\cic_signal_flow_2dsp'
)
$workDir = [System.IO.Path]::GetFullPath(
    'D:\FpgaProject\XilinxProject\XC7A35T\fir_interpolation\submit\finally\images\work\cic_signal_flow_2dsp'
)
$outputDir = [System.IO.Path]::GetFullPath(
    'D:\FpgaProject\XilinxProject\XC7A35T\fir_interpolation\submit\finally\images\generated\cic_signal_flow_2dsp'
)
$baseName = 'cic-hold16-signal-flow'
