...
#
# Generated by export_simulation on Thu May 28 19:58:43 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_audio_44k1.sh' script.

./clk_wiz_audio_44k1.sh -reset_run
...
./clk_wiz_audio_44k1.sh -noclean_files

For more information on the script, please type './clk_wiz_audio_44k1.sh -help'.
