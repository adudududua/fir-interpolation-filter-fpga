...
#
# Generated by export_simulation on Thu May 28 20:00:49 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_audio_48k.sh' script.

./clk_wiz_audio_48k.sh -reset_run
...
./clk_wiz_audio_48k.sh -noclean_files

For more information on the script, please type './clk_wiz_audio_48k.sh -help'.
