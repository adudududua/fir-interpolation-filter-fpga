...
puts $manifest_handle "Stage1 DSP-register optimization: current L0 is written then read from the single RAMB18; DSP48E1 AREG retains each left operand and dynamic INMODE masks invalid A/D history, removing the 24-bit fabric left register and operand masks"
