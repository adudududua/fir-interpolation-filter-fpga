%% 1）主流程：phase7_06_validate_folded_bittrue
...
% 3）局部函数模块：floating_full_reference


% 功能说明：封装 floating_full_reference 对应的局部计算，供主流程复用并保持代码层次清晰。
...
% 10）局部函数模块：write_signed_hex_mem
...
% 13）局部函数模块：plot_full_chain_acceptance
