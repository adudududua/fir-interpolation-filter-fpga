#=============================================================
# 文件名       : synth_stage1_strict_ff.tcl
# 脚本名       : synth_stage1_strict_ff
# 功能简述     : 对 V3 Phase 3B Stage 1 strict-halfband FF 版本
#                执行独立综合，导出层次资源、总资源、时序和检查点。
#
# 当前默认配置：
#                  FPGA 型号：xc7a35tfgg484-2
#                  顶层模块：interp128_all2x_v3_strict_s1_top_ce
#                  Stage 1 ：105 tap Q15，52x24bit FF 历史
...
# 开发工具     : Vivado
# 修订记录     :
#                2026-07-11：新增 Stage 1 strict-halfband FF 综合脚本。
#=============================================================
...
set result_dir [file normalize [file join $script_dir .. \
    vivado_results phase3_stage1_strict_ff]]
...
read_verilog [list \
    ...
    [file join $v3_src_dir interp128_all2x_v3_strict_s1_top_ce.v]]

set_property include_dirs [list $v2_src_dir $v3_src_dir] [current_fileset]

synth_design -top interp128_all2x_v3_strict_s1_top_ce \
...
puts "Phase 3 Stage 1 strict-halfband FF synthesis completed."
