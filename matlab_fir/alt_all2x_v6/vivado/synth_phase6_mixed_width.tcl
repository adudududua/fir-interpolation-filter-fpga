#=============================================================
# 文件名       : synth_phase6_mixed_width.tcl
# 脚本名       : synth_phase6_mixed_width
# 功能简述     : 对 Phase 6 混合数据字长七级 2x 插值链执行
#                独立综合，导出总资源、层次资源、DSP 映射、
#                时序和检查点，并与 Phase 5 全 24bit 基线比较。
#
# 当前默认配置：
...
# 开发工具     : Vivado
# 修订记录     :
#                2026-07-13：新增 Phase 6 混合字长综合脚本。
#=============================================================
...
create_project phase6_mixed_width $temp_project_dir \
...
set_property generic [list STAGE23_ACC_W=$stage23_acc_w] \
    [get_filesets sources_1]
...
if {[get_property PROGRESS [get_runs synth_1]] != "100%"} {
    error "Phase 6 mixed-width synthesis did not complete."
}
...
puts "Phase 6 mixed-width synthesis completed."
close_project
