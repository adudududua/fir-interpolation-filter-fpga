...
//                2026-07-19：导出第一级零插值输入调试节点，供
//                            ILA 镜像抑制演示使用，不改变数据路径。
//=============================================================
...
module interp128_all2x_v7_folded_fir_cic_top_ce #(
    ...
    output wire signed [23:0]           dbg_stage1_fir_in,
    output wire                         dbg_stage1_fir_in_valid
);
    ...
    interp2_stage1_strict_halfband_bram_ce #(
        ...
        .fir_in_dbg(stage1_fir_in_w),
        .fir_in_valid_dbg(stage1_fir_in_valid_w)
    );
    ...
    assign dbg_stage1_fir_in = stage1_fir_in_w;
    assign dbg_stage1_fir_in_valid = stage1_fir_in_valid_w;
